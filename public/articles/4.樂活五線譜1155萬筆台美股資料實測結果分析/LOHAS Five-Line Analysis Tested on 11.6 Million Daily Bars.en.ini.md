...
The LOHAS five-line chart and the LOHAS Channel are two charts on the page. Every number in this article comes from reading the two of them together, for two reasons.
...
If deviations really followed a bell curve, everything beyond two standard deviations would take up under 5% of days. In practice the two ends together run 17% to 22%, four times the theoretical figure. Price hits those extremes more often than theory says, and trends persist: after running hot, price often keeps running, so "Extreme Greed" stays lit for weeks.
...
| Group | Days at a sentiment extreme where the channel also broke out |
|---|---|
| Market indices | 49% |
| Taiwan stocks | 45% |
| Non-index ETFs | 42% |
...
The numbers in the table are what you make by buying on the day this combination appears and holding to the end of the period, above what you would make buying on any random day, in percentage points. Buying on any random day is called random entry below, and it is roughly the result someone gets by ignoring the signal. A percentage point is the gap between two returns: 20% on the signal against 9% on random entry is a gap of 11 points.

| What you see on the page (vs random entry) | Days per year | Held 1 month | Held 3 months | Held 6 months | Held 1 year |
|---|---|---|---|---|---|
...
The numbers read the same way as the previous table: buy on the day the signal appears, and make this many percentage points more than random entry.

Read the last column alongside them. The gain is a median and a few strong names can lift it; the last column tells you how many instruments in the group did the same thing.

| Group (vs random entry) | Held 1 month | Held 3 months | Held 6 months | Held 1 year | How many did the same at 1 year |
|---|---|---|---|---|---|
...
This table compares two moments: waiting for price to return inside the channel, against buying on the day of the break.

| Group (wait vs buy on the break) | Held 1 month | Held 3 months | Held 6 months | Held 1 year | How many did the same at 1 year |
|---|---|---|---|---|---|
...
Six groups, four holding periods, no exceptions: waiting wins every time. Over 95% of the instruments in every group did the same. Buy on the day of the break and all six groups are negative over one month.

Price outside the channel means that decline is still running, and acting there means working against it. Once price is back inside, the fall has at least paused.
...
This does not mean it turns tomorrow. In the three months after the signal, index ETFs fall a further 10.0% at the deepest point, against 4.6% for random entry. Those two are drawdowns in their own right, which is a different thing from the gaps between returns used elsewhere. Anyone going all in on the signal has to sit through that stretch.
...
The sell point is the day the "Extreme Greed + above upper edge" breakout ends and price returns inside the channel, a median of 10 trading days after the signal, roughly two weeks. Why that day rather than the day of the break is tested in the next subsection.

### Which instruments suit it

The numbers in the table are how much further price fell after selling on the signal than it did after a random sale, in percentage points. The further it fell, the more that sale dodged.

| Group (vs random sale) | 1 month after | 3 months after | 6 months after | 1 year after | How many did the same at 1 month |
|---|---|---|---|---|---|
...
Note: 35,160 sell points across 1,441 instruments. Taken together, 1,360 of the 1,441 did the same.
...
The same question as when buying: sell the day price breaks above the upper edge, or wait for it to return inside?

This table compares two moments: waiting for price to return inside the channel, against selling on the day of the break.

| Group (wait vs sell on the break) | 1 month after | 3 months after | 6 months after | 1 year after | How many did the same at 1 month |
|---|---|---|---|---|---|
...
Again there are no exceptions: waiting wins every time. Sell on the day of the break and price keeps climbing that month, in five of the six groups faster than after a random sale, which means selling into the middle of the run.

The original advice holds when buying and when selling, and across all four periods.

### Dodging a fall is not the same as making money

Sell and sit in cash and the market's long-run climb means that after a year you end up behind someone who held throughout. This article does not test when to buy back; that is a separate question.

## Further check: the 2008 exception only shows up over short holds

Everything so far pools all the years together. A signal that only works in one stretch of history is probably a coincidence, so here is the data cut by period. This section confirms whether the earlier findings survive different eras, and can be skipped if you only want to know how to use the tool.
...
The numbers in the table are what you make by buying during that period, above random entry, in percentage points (index ETFs only).

| Period (vs random entry) | Held 1 month | Held 3 months | Held 6 months | Held 1 year |
|---|---|---|---|---|
...
The numbers in the table are what adding that condition makes above adding nothing, in percentage points.
...
Over one month, RSI below 30 beats the LOHAS Channel. It ranks first in three of the five groups and second in the other two. Close behind it is high volatility. The Channel comes second only for market indices; in the other four groups it sits mid-table or lower, and for Taiwan stocks it is below adding nothing at all.

The two cover different lengths of time. The Channel's value shows up over a year, at 11.1 percentage points; the one-month bounce is caught better by RSI.
